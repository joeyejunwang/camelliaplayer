...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _pickVideo() async {
    ...
    _openPlayer(videoFile, file.name, foundSubtitle, foundSubtitle?.path.split(Platform.pathSeparator).last);
  }

  void _openPlayer(File? videoFile, String? videoPath, File? subtitleFile, String? subtitlePath) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => PlayerScreen(
          videoFile: videoFile,
          videoPath: videoPath,
          videoName: videoPath ?? 'video',
