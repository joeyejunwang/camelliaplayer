...
///
/// The optional [lyricIndex] remembers the cue that was on screen when
/// the user closed the player so reopening the file resumes at the
/// same lyric instead of jumping back to the very first one.
class LastPlayed {
  LastPlayed({
    required this.path,
    required this.name,
