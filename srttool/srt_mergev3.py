...
# # On Linux / macOS
# ffmpeg -i input.mp4 -af "silencedetect=noise=-50dB:d=1" -f null - 2>&1 | grep silencedetect > silence_log.txt

# # On Windows PowerShell
# ffmpeg -i input.mp4 -af "silencedetect=noise=-50dB:d=1" -f null - 2>&1 | Select-String "silencedetect" > silence_log.txt